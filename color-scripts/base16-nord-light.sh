...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Nord Light"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-nord-light"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#e5e9f0', '#99324b', '#4f894c', '#9a7500', '#3b6ea8', '#97365b', '#398eac', '#2e3440', '#aebacf', '#ac4426', '#c2d0e7', '#b8c5db', '#60728c', '#3b4252', '#5272af', '#29838d']"
...
gset string palette "['#e5e9f0', '#99324b', '#4f894c', '#9a7500', '#3b6ea8', '#97365b', '#398eac', '#2e3440', '#aebacf', '#ac4426', '#c2d0e7', '#b8c5db', '#60728c', '#3b4252', '#5272af', '#29838d']"
