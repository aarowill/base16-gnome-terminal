...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#2d2d2d', '#f2777a', '#99cc99', '#ffcc66', '#6699cc', '#cc99cc', '#66cccc', '#cccccc', '#999999', '#f99157', '#393939', '#515151', '#b4b7b4', '#e0e0e0', '#a3685a', '#ffffff']"
...
gset string palette "['#2d2d2d', '#f2777a', '#99cc99', '#ffcc66', '#6699cc', '#cc99cc', '#66cccc', '#cccccc', '#999999', '#f99157', '#393939', '#515151', '#b4b7b4', '#e0e0e0', '#a3685a', '#ffffff']"
