...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 standardized-dark 256"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-standardized-dark-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#222222', '#e15d67', '#5db129', '#e1b31a', '#00a3f2', '#b46ee0', '#21c992', '#c0c0c0', '#898989', '#e15d67', '#5db129', '#e1b31a', '#00a3f2', '#b46ee0', '#21c992', '#ffffff']"
